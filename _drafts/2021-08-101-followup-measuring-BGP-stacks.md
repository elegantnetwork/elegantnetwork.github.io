...
# Results
The first set of results we'll look at are from my AMD 3970 32 core machine with 64 GB RAM.
### 10K prefixes
...
![route reception time](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_10K_route_reception.png)
...
![max cpu](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_10K_max_cpu.png)

Rusty BGP uses a lot more  CPU resources. 

![max mem](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_10K_max_mem.png)
...
![route reception time](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_many_neighbors_10p_route_reception.png)

The time to receive prefixes, all 10 per neighbor, doesn't matter in this test.

![max cpu](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_many_neighbors_10p_max_cpu.png)

Interestingly, Rustybgp uses the smallest amount of CPU and OpenBGPD uses the most, by lot. FRRouting 8 uses more  CPU at 1750 neighbors 7.5.1. I don't know that is important since it's still not very much

![max mem](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_many_neighbors_10p_max_mem.png)
...
![route reception time](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_many_neighbors_100p_route_reception.png)

Again, route reception is trivial. Maybe it matters that OpenBGPD at 750 neighbors is 4 seconds, but not sure.

![max cpu](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_many_neighbors_100p_max_cpu.png)

Similar to the 10 prefix tests, OpenBGPD uses many more CPU resources than the others.

![max mem](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_many_neighbors_100p_max_mem.png)
...
![route reception time](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_prefix_growth_route_reception.png)

route reception is trivial, except OpenBGPD at 250 neighbors, 1000 prefixes. It plain freaks out.


![max cpu](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_prefix_growth_max_cpu.png)


![max mem](/assets/images/2021-08-followup-bgp-stacks/AMD-3970/bgperf_prefix_growth_max_mem.png)
