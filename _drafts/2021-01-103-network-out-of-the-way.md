...
I think one of the worse operational mistakes is recabling a networking. Let's say you have 4 core routes and 18 aggregation routes (the aggregation routers are in pairs) and you realize you need more aggregation routers than you can support and you need more bandwidth than you can support. So you decide you want to have 8 core routers. Almost certainly you will have to recable between layers. [DD: This is such an important example and section. Maybe spend a little time expanding this example so everyone can follow]
...
[DD: Maybe in the prev paragraph or separately, talk about how people try to make the network do things that are not in networks purview and how that complicates the network and hinders agility/reliability/flexibility]
...
[DD: Maybe talk here about how SDN focused on the wrong thing. A SDN's main point has to be the software that's reducing the operating costs, not Openflow. OTOH, it may distract]
